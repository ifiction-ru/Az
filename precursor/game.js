...
//----------
РеакцияНаСобытие({'событие':СобытиеПереместить, 'что':Сундук, 'куда':ИГРОК}, function() {
   Вывести('п. Сундук глубоко вкопан. Просто так не вытащить.');
   //return НЕТ;
});
//----------
// ИГРОК
    ...
    Сундук.Действие(
        ...
        function() {
            if (Сундук.Переместить(ИГРОК) == true) {
                Вывести('п. Вы приподняли сундук.');
            } // end if
        });
/* --------------------------------------------------------------------------- */
