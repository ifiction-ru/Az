...
INTERFACE.ready(function () {
    INTERFACE.setTitle('Название игры');
});
//----------
...
/*
    ...
    Да, дело дрянь. Тушито Кутуш, ваш якобы партнёр в этом плавании, вместе
    с парой своих громил застал вас врасплох, скрутил и на рассвете привёз на этот
    крошечный остров посреди океана, где бросил умирать от голода и жажды.
    И увёз вашу карту сокровищ, ваш козырь в этом плавании. Карту, ради которой он
    готов был пойти на всё. Как и остальная команда корабля.
    И теперь он уплывал с картой к кораблю, напоследок повертев ею перед вашим носом
    и великодушно оставив верёвку, чтобы вы могли повеситься, саблю, чтобы заколоться, и
    пистолет, чтобы застрелиться, когда будет совсем невмочь. Такое у него было чувство
    юмора.
    - Ты любил повторять, что смерть обходит тебя стороной? Вот и проверим. — такие были
    последние его слова.
    Мысль незамедлительно воспользоваться оставленным пистолетом из вас выбили одним
    ударом приклада - вы нащупали огромную шишку на затылке - после чего просто взяли и
    уплыли.
    Что же делать?
    
    Среди берегового братства пиратов вы слывёте одним из самых удачливых искателей
    приключений, а ваше 
...
var Вступление = new Текст('Вступление','\n\n\
    ...
    Затем поднялись на ноги и некоторое время смотрели вслед удаляющейся лодке.\n\n\
    <- далее ->\n\n\
    Да, дело дрянь. Тушито Кутуш, ваш якобы партнёр в этом плавании, вместе с парой своих громил застал вас врасплох, скрутил и вывез на этот крошечный остров посреди океана, где бросил умирать от голода и жажды.\n\n\
    ...
    Мысль незамедлительно воспользоваться оставленным пистолетом из вас выбили одним ударом приклада - вы нащупали огромную шишку на затылке - после чего просто взяли и уплыли.\n\n\
    Что же делать?', function () {
...
// БЕРЕГ
    ...
    Берег.Описание('Берег океана', function(param) {
        ...
        if (param == 'кратко') {
            ...
            Сейчас штиль, и поэтому прозрачные волны лениво накатываются на белоснежный песок, изредка принося листья водорослей. И из-за этого штиля, кстати, бывший ваш корабль до сих пор стоит на якоре на некотором удалении от берега.';
        } // end if
        //----------
        return result;
    });
