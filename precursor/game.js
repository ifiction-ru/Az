...
//----------
Установить('Название игры', 'Остров опальных пиратов');
//----------
INTERFACE.ready(function () {
    INTERFACE.setTitle('Остров опальных пиратов');
    INTERFACE.setHeading('Остров опальных пиратов');
});
//----------
...
Вступление.Текст = '\n\n\
    ...
    Мысль незамедлительно воспользоваться оставленным пистолетом и пристрелить кого-нибудь из вас выбили одним ударом приклада - вы нащупали огромную шишку на затылке - после чего просто взяли и уплыли.\n\n\
    Что же делать?'
