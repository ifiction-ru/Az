        ...
        Пистолет.Описание('пистолет', function () {
            if (Пистолет.Заряжен == ДА) {
                if (Пистолет.Проверяли == НЕТ) {
                    ...
                    return 'Обычный пистолет. Кремнёвый замок цел, порох на полке есть. Вынув шомпол, вы проверили ствол - ого, похоже, даже пуля забита!';
                } else {
                    return 'Заряженный пистолет. Кремень, порох, пуля - всё на месте.';
                } // end if
            } else {
                return '...';
            } // end if
